...
# 使用する環境変数を全て取得
SERVER_PORT = get_valid_str_env("FRONT_SERVER_PORT")
PONG_ORIGIN = f"https://localhost:{SERVER_PORT}"
...
INSTALLED_APPS = [
    ...
    "accounts.two_factor_authentication.otp",
    "accounts.two_factor_authentication.temporary_user",
    "users",
    "users.friends",
    "users.blocks",
    "ws",
